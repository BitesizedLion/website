...
Virtualization allows for better utilization of resources in a physical server and allows
for better scalability because an application can be added or updated easily, reduces
